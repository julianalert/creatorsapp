  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4">
      ...
      <div className="flex items-center justify-between">
        {/* Left side */}
        <button className="p-2 shrink-0 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-blue-500 transition">
