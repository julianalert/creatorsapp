  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4">
      ...
      <div className="mb-3">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Publishing industries for previewing layouts and visual <a className="font-medium text-blue-500 hover:text-blue-600 dark:hover:text-blue-400" href="#0">#family</a> 🔥</div>
