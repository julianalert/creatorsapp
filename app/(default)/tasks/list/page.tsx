        ...
        <div className="sm:flex sm:justify-between sm:items-center mb-8">
          ...
          <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4">
            ...
            <div className="flex shrink-0 -space-x-3 -ml-px">
              ...
              <button className="flex justify-center items-center w-9 h-9 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-blue-500 shadow-sm transition ml-2">
              ...
              <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4" draggable="true">
                <div className="sm:flex sm:justify-between sm:items-start">
                  ...
                  <div className="flex items-center justify-end space-x-3">
                    ...
                    {/* Like button */}
                    <button className="flex items-center text-gray-400 dark:text-gray-500 hover:text-blue-500 dark:hover:text-blue-500">
