...
export default function Notification({
  ...
  const typeIcon = (type: string): ReactElement<any> => {
    switch (type) {
      ...
      default:
        return (
          <svg className="shrink-0 fill-current text-blue-500 mt-[3px] mr-3" width="16" height="16" viewBox="0 0 16 16">
        ...
        <div className={className} role="alert">
          <div className="inline-flex flex-col w-full max-w-lg px-4 py-2 rounded-lg text-sm bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700/60 text-gray-600 dark:text-gray-400">
            ...
            <div className="text-right mt-1">
              <a className="font-medium text-blue-500 hover:text-blue-600 dark:hover:text-blue-400" href="#0">Action -&gt;</a>
            </div>
          </div>
        </div>
      }
